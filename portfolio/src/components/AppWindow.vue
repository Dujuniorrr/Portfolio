<template>
  ...
  .top { top:0; left:50%; transform:translateX(-50%); width:10px; height:5px; cursor:ns-resize; }
  .top-right { top:0; right:0; width:10px; height:10px; cursor:nesw-resize; }
  .right { top:50%; right:0; transform:translateY(-50%); width:5px; height:10px; cursor:ew-resize; }
  .bottom-right { bottom:0; right:0; width:10px; height:10px; cursor:nwse-resize; }
  .bottom { bottom:0; left:50%; transform:translateX(-50%); width:10px; height:5px; cursor:ns-resize; }
  .bottom-left { bottom:0; left:0; width:10px; height:10px; cursor:nesw-resize; }
  .left { top:50%; left:0; transform:translateY(-50%); width:5px; height:10px; cursor:ew-resize; }
